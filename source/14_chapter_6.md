...
For participants who recalled carrying out work with asbestos a detailed assessment of each work task was recorded. A fibre-ml.year asbestos exposure (AE) estimate was calculated using a source-receptor model[@Cherrie1999][@Cherrie2018]: 
...
having ever been exposed to a high or medium asbestos exposure risk job, odds ratio for interaction 1.9 (95%CI 1.03-3.36, p \ensuremath{<} 0.04). Several non-significant gene-environment interactions were present (see Table 6.7).
